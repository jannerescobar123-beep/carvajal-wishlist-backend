...
class ProductControllerTest {
    ...
    void update_shouldReturnUpdatedProduct() throws Exception {
        ProductDTO request = createProduct(null, "Laptop Updated");
        ProductDTO response = createProduct(1L, "Laptop Updated");

        when(productService.update(eq(1L), any(ProductDTO.class))).thenReturn(response);
    ...
    void create_withBlankName_shouldReturnBadRequest() throws Exception {
        ProductDTO request = createProduct(null, "");
